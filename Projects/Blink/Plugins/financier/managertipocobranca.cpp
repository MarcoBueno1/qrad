#include "managertipocobranca.h"
#include "ui_managertipocobranca.h"
...
#define SQL_ITEMS "select id,id from tipocobranca order by id" 

Managertipocobranca::Managertipocobranca(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Managertipocobranca)
{
    ui->setupUi(this);
...
Managertipocobranca::~Managertipocobranca()
{
     if( m_keyinterval )
     {
       m_keyinterval->stop();
...
void Managertipocobranca::KeyPressTimeout()
{
...
void Managertipocobranca::StartTimer( QString )
{
...
void Managertipocobranca::Found(QModelIndex)
{
...
void Managertipocobranca::notFound()
{
   ui->lineEditSearch->setStyleSheet(FG_COLOR_NOT_FOUND + BG_COLOR_NOT_FOUND);
  // ui->tableViewSearch->selectRow(0);
}
void Managertipocobranca::TableClicked(QModelIndex currentIndex)
{
    qDebug() << "TableClicked";
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
...
void Managertipocobranca::CurrentChanged(QModelIndex currentIndex)
{
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
    ui->lineEditSearch->setText(currentIndex.sibling(currentIndex.row(),BN_DEFAULT_COLUMN_SEARCH).data().toString());
    ui->lineEditSearch->selectAll();
...
void Managertipocobranca::ShowCurrentInformations( void )
{
    QString strTemp;
...
void Managertipocobranca::LoadTableView()
{
...
void Managertipocobranca::DoRefresh()
{
    ui->tableViewSearch->SetNoEmptySearch( true );
...
void Managertipocobranca::refreshTable()
{
...
void Managertipocobranca::ConfigureTable()
{
...
void Managertipocobranca::keyPressEvent(QKeyEvent *event)
{
...
void Managertipocobranca::MatchNewest(tipocobranca *newest )
{
    DoRefresh();
...
void Managertipocobranca::doEditar()
{
    Edittipocobranca *edt = new Edittipocobranca;
    ...
    tipocobranca *sa = tipocobranca::findByPrimaryKey(nId);
    edt->SetModel(sa);
...
void Managertipocobranca::doNovo()
{
    Edittipocobranca *edt = new Edittipocobranca;
...
void Managertipocobranca::doSair()
{
