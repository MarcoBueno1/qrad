...
void Managerprofile::KeyPressTimeout()
{
...
void Managerprofile::StartTimer( QString )
{
...
void Managerprofile::Found(QModelIndex)
{
...
void Managerprofile::notFound()
{
   ui->lineEditSearch->setStyleSheet(FG_COLOR_NOT_FOUND + BG_COLOR_NOT_FOUND);
  // ui->tableViewSearch->selectRow(0);
}
void Managerprofile::TableClicked(QModelIndex currentIndex)
{
    qDebug() << "TableClicked";
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
...
void Managerprofile::CurrentChanged(QModelIndex currentIndex)
{
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
    ui->lineEditSearch->setText(currentIndex.sibling(currentIndex.row(),BN_DEFAULT_COLUMN_SEARCH).data().toString());
    ui->lineEditSearch->selectAll();
...
void Managerprofile::ShowCurrentInformations( void )
{
    QString strTemp;
...
void Managerprofile::LoadTableView()
{
...
void Managerprofile::refreshTable()
{
...
void Managerprofile::keyPressEvent(QKeyEvent *event)
{
...
void Managerprofile::MatchNewest(profile *newest )
{
    DoRefresh();
...
void Managerprofile::doEditar()
{
    ...
    profile *sa = profile::findByid(nId);
    edt->SetModel(sa);
