...
void Manageruser::KeyPressTimeout()
{
...
void Manageruser::StartTimer( QString )
{
...
void Manageruser::Found(QModelIndex)
{
...
void Manageruser::notFound()
{
   ui->lineEditSearch->setStyleSheet(FG_COLOR_NOT_FOUND + BG_COLOR_NOT_FOUND);
  // ui->tableViewSearch->selectRow(0);
}
void Manageruser::TableClicked(QModelIndex currentIndex)
{
    qDebug() << "TableClicked";
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
...
void Manageruser::CurrentChanged(QModelIndex currentIndex)
{
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
    ui->lineEditSearch->setText(currentIndex.sibling(currentIndex.row(),BN_DEFAULT_COLUMN_SEARCH).data().toString());
    ui->lineEditSearch->selectAll();
...
void Manageruser::ShowCurrentInformations( void )
{
    QString strTemp;
...
void Manageruser::LoadTableView()
{
...
void Manageruser::keyPressEvent(QKeyEvent *event)
{
...
void Manageruser::MatchNewest(user *newest )
{
    DoRefresh();
