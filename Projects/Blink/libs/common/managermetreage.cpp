...
Managermetreage::~Managermetreage()
{
     if( m_keyinterval )
     {
       m_keyinterval->stop();
...
void Managermetreage::KeyPressTimeout()
{
...
void Managermetreage::StartTimer( QString )
{
...
void Managermetreage::Found(QModelIndex)
{
...
void Managermetreage::notFound()
{
   ui->lineEditSearch->setStyleSheet(FG_COLOR_NOT_FOUND + BG_COLOR_NOT_FOUND);
  // ui->tableViewSearch->selectRow(0);
}
void Managermetreage::TableClicked(QModelIndex currentIndex)
{
    qDebug() << "TableClicked";
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
...
void Managermetreage::CurrentChanged(QModelIndex currentIndex)
{
    ui->lineEditSearch->setStyleSheet(AUTO_CONFIG_FOCUS);
    ui->lineEditSearch->setText(currentIndex.sibling(currentIndex.row(),BN_DEFAULT_COLUMN_SEARCH).data().toString());
    ui->lineEditSearch->selectAll();
...
void Managermetreage::ShowCurrentInformations( void )
{
    QString strTemp;
...
void Managermetreage::LoadTableView()
{
...
void Managermetreage::DoRefresh()
{
    ui->tableViewSearch->SetNoEmptySearch( true );
...
void Managermetreage::refreshTable()
{
...
void Managermetreage::ConfigureTable()
{
...
void Managermetreage::keyPressEvent(QKeyEvent *event)
{
...
void Managermetreage::MatchNewest(metreage *newest )
{
    DoRefresh();
...
void Managermetreage::doEditar()
{
    Editmetreage *edt = new Editmetreage;
    ...
    metreage *sa = metreage::findByPrimaryKey(nId);
    edt->SetModel(sa);
