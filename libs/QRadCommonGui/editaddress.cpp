    ...
    ui(new Ui::Editaddress)
{
    ...
    ui->CmbBxstreet->setTable("street.Rua");
    ui->CmbBxstreet->setField("name.Nome");
    ui->CmbBxstreet->setCanAdd(true);
    ui->CmbBxstreet->setUserName("dsm");
    ui->CmbBxstreet->completer()->setFilterMode(Qt::MatchContains );
    ui->CmbBxcep->setTable("cep");
    ui->CmbBxcep->setField("number.Numero");
    ui->CmbBxcep->setCanAdd(true);
    ui->CmbBxcep->setUserName("dsm");
    ui->CmbBxcep->completer()->setFilterMode(Qt::MatchContains );
    ui->CmbBxNeighborhood->setTable("neighborhood.Bairro");
    ui->CmbBxNeighborhood->setField("name.Nome");
    ui->CmbBxNeighborhood->setCanAdd(true);
    ui->CmbBxNeighborhood->setUserName("dsm");
    ui->CmbBxNeighborhood->completer()->setFilterMode(Qt::MatchContains );
    ui->CmbBxcity->setTable("city.Cidade");
    ui->CmbBxcity->setField("Name.Nome");
    ui->CmbBxcity->setCanAdd(true);
    ui->CmbBxcity->setUserName("dsm");
    ui->CmbBxcity->completer()->setFilterMode(Qt::MatchContains );
    ui->CmbBxstate->setTable("state.Estado");
    ui->CmbBxstate->setField("name.Nome");
