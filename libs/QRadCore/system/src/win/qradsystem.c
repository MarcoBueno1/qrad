...
int QRad_WaitForSingleEvent( sem_t_qrad *pEvent,
                            int iTimeout )
{
  int iResult;
  
  iTimeout= iTimeout==QRad_WAIT_INFINITE?INFINITE:iTimeout;
...
int QRad_WaitForSingleMutex( pthread_mutex_t_qrad *pMutex,
                            int iTimeout)
{
  int iResult = -1;
...
int QRad_CreateEvent( sem_t_qrad *pSem,
                     int p1, 
                     int p2 ) 
{
...
int QRad_CreateThread( pthread_t_qrad * hThread,
                      void * (*pFunction)(void *), 
                      void *pParameter )
{
  DWORD dwThreadID;
