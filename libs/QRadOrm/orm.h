...
{
    ORM_ATTR_QString    = 0x01,
    ORM_ATTR_int        = 0x02,
    ORM_ATTR_double     = 0x03,
    ORM_ATTR_bool       = 0x04,
    ORM_ATTR_QDate      = 0x05,
    ORM_ATTR_QTime      = 0x06,
    ORM_ATTR_QChar      = 0x07,
    ORM_ATTR_char       = 0x08,
    ORM_ATTR_Serial     = 0x09,
}ORMAttrType;
...
#define IS_STRING_VALUE(attr) ((ORM_ATTR_QString == attr->type()) || (ORM_ATTR_QDate == attr->type()) || \
                               (ORM_ATTR_QTime == attr->type()) || ( ORM_ATTR_QChar == attr->type()) || \
                               (ORM_ATTR_char  == attr->type()))

#define ORM_ATTRIBUTE_CLASS(attrType)\
...
ORM_ATTRIBUTE_CLASS(QString);
ORM_ATTRIBUTE_CLASS(QDate);
ORM_ATTRIBUTE_CLASS(QTime);
ORM_ATTRIBUTE_CLASS(QChar);
ORM_ATTRIBUTE_CLASS(int);
ORM_ATTRIBUTE_CLASS(double);
ORM_ATTRIBUTE_CLASS(bool);
...
#define ORM_DECLARE_FOREINGKEY(className, attrType, attrId, obj, objType) \
        protected:\
        ...
        public:\
            ...
            static className##List * findBy##attrId(attrType value, QSqlDatabase db = QSqlDatabase::database())\
            {\
               return findByAttribute(#attrId, value, db );\
            }
